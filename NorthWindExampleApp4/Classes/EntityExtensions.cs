...
public static class EntityExtensions
{
    ...
    public static List<SqlColumn> GetModelProperties(this DbContext context, string modelName)
    {
        ...
        id += 1;
        list.Add(new SqlColumn() {Id = id, Name = "FirstName", IsNavigation = true, NavigationValue = "Contact.FirstName" });
        id += 1;

        list.Add(new SqlColumn() { Id = id, Name = "LastName", IsNavigation = true,NavigationValue = "Contact.LastName" });
